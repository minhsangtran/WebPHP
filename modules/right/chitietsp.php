                        	...
                        	<p>
                            	<strong>Tên sản phẫm: </strong><em style="color:red"><?php echo $dong['tensp'] ?></em></p>
                                           ...
                                           <p><strong>Số lượng:</strong><input type="text" name="soluong" size="3" value="1" /></p>
                                           	 <input type="submit" name="add_to_cart" value="Mua hàng" style="margin:10px;width:100px;height:40px;background:#2abae3;color:#000;font-size:18px;border-radius:8px;" />
